package com.yfming.tensquare.base.service;

import com.yfming.tensquare.base.dao.LabelDao;
...
public class LabelService {
    ...
    public Page<Label> findSearch(Map searchMap, int page, int size) {
        Specification specification = createSpecification(searchMap);
        PageRequest pageRequest = PageRequest.of(page - 1, size); return labelDao.findAll(specification, pageRequest);
    }
}